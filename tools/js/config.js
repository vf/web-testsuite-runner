...
var DEST_FILE = arguments[1];
var destFileSegments = DEST_FILE.split("/"); // This is something like "/Users/cain/bla/config.xml"
var TARGET_FILE = destFileSegments.pop(); // This shall become "config.xml" or "index.html"
var DEST_PATH = util.endInSlash(destFileSegments.join("/")); // This shall be "/Users/cain/bla/"
var TEST_FILE = relativePath(DEST_PATH, arguments[2]); // E.g. "tests/w3c/config.xml/warp.js"
